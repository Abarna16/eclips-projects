...
public class SecondServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
		...
		object.println("httpmethod :"+method);
		object.println("user-agent :" +req.getHeader("user-agent"));
		object.println("page :" +req.getHeader("referer"));
		object.println("time of request"+java.time.LocalTime.now());
